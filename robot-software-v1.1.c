/*
	VAN ALSTYNE HIGH SCHOOL ROBOTICS

	     AUTHORS: ZACHARY BALDWIN,
	     					NATE MONTGOMERY
	FILE VERSION: 1.2
					 URL: HTTPS://WWW.GITHUB.COM/ZACHARYJBALDWIN/COCO-BEST-VEX-ROBOTCS-CODE-RBC
*/
...
task main {
	...
	{
		// DRIVE MOTORS //
		arcadeControl(Ch3, Ch4, 10); // MAKES IT POSSIBLE TO USE ONE JOYSTICK TO CONTROL BOTH DRIVE MOTORS
